...
export const ExaminationView: React.FC<ExaminationViewProps> = ({
  ...
  const handleQuickFillForTesting = () => {
    ...
    const mockEssays: Record<number, string> = {
      14: 'หลักการของการบังคับบัญชาแบบกระจายอำนาจ (Mission Command) มุ่งเน้นการมอบเจตนารมณ์ที่ชัดเจนจากผู้บังคับบัญชา เพื่อให้ผู้บังคับหน่วยระดับย่อยสามารถตัดสินใจและปรับกลยุทธ์ได้อย่างรวดเร็วในสภาวะวิกฤต เช่น การรบในพื้นที่ปิดล้อมหรือการสื่อสารถูกตัดขาดโดยสิ้นเชิง',
      15: 'จุดอ่อนด้านการส่งกำลังบำรุงในปฏิบัติการปิดล้อมคือเส้นทางส่งกำลังหลักถูกสกัดกั้น มาตรการแก้ไข 3 ประการได้แก่: 1. สถาปนาการส่งกำลังทางอากาศด้วยโดรนหรือร่มชูชีพ 2. จัดตั้งคลังสัมภาระซ่อนพรางส่วนหน้า 3. บังคับใช้อัตราการจ่ายเสบียงและกระสุนอย่างเคร่งครัดตามลำดับความสำคัญ',
      16: 'ขั้นตอนการเข้ากวาดล้างอาคาร (Room Clearing) ต้องใช้หลัก Fatal Funnel, การกระจายมุมยิง (Sector of Fire) การสื่อสารแบบ Non-verbal และการจัดตั้งแนวป้องกันรอบนอกอาคารเพื่อป้องกันการตีโต้',
      17: 'เมื่อตกในพื้นที่สังหารของการซุ่มโจมตีระยะใกล้ (Near Ambush) กำลังพลต้องเข้าทำการยิงและเคลื่อนที่เข้าหาข้าศึกทันทีเพื่อทำลายแหล่งกำเนิดการยิง พร้อมปาระเบิดควันและถอนตัวอย่างรวดเร็ว',
